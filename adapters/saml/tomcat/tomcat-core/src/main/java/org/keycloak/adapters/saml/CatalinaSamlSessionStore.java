...
public class CatalinaSamlSessionStore implements SamlSessionStore {
    ...
    protected final PrincipleFactory principalFactory;
    ...
    public CatalinaSamlSessionStore(CatalinaUserSessionManagement sessionManagement, PrincipleFactory principalFactory,
