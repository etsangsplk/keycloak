...
public class CatalinaCookieTokenStore implements AdapterTokenStore {
    ...
    private PrincipleFactory principalFactory;

    private KeycloakPrincipal<RefreshableKeycloakSecurityContext> authenticatedPrincipal;

    public CatalinaCookieTokenStore(Request request, HttpFacade facade, KeycloakDeployment deployment, PrincipleFactory principalFactory) {
